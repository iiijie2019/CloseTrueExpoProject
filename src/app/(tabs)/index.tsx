...
const s = StyleSheet.create({
  ...
  smallEntry: { borderRadius: 23, padding: 18, flex: 1, minHeight: 212, borderWidth: 1, borderColor: '#FFFFFFB0', overflow: 'hidden' },
