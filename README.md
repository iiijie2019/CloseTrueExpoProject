...
- 600 个离线词条、32 组词根词缀，中英释义、词性、IPA、例句与常见变化。
- 首页采用紧凑统计卡、三个学习入口和生活场景快捷入口；单词的词性／主题筛选可展开收起。浅色卡片、柔和毛玻璃与过渡动画适配手机和宽屏。
- 最近扩充 240 个基础与生活词条，每词配原创双语例句；补齐不规则动词、名词复数、比较级和易混用法。句子课程保留 30 课，避免重复句型。
- 已掌握／未掌握标签点击切换，支持撤销；首页可换词，词族与详情同步状态。
- 时间、数量、食物、日常物品、人物关系、自然天气、交通旅行、学习工作、家居房间、身体健康十类主题，与关键词、词性、掌握状态组合筛选。列表每批加载 30 条。
