...
- 1,000 个离线词条、32 组词根词缀，中英释义、词性、IPA、例句与常见变化。
- 首页采用紧凑统计卡、三个学习入口和生活场景快捷入口；单词的词性／主题筛选可展开收起。浅色卡片、柔和毛玻璃与过渡动画适配手机和宽屏。
- 最近再扩充 200 个实用词条，覆盖饮食、家居、出行、人物关系、职场、自然天气及常用动作；每词配原创双语例句、音标及适用词形。句子课程保留 30 课，避免重复句型。
- 首页和我的页移除「最近的小发现」；首页可直达全部 14 类主题，已选词性／主题可单独移除。基础词详情只在有实际拆分时显示构词卡片。
- 已掌握／未掌握标签点击切换，支持撤销；首页可换词，词族与详情同步状态。
- 时间、数量、食物、日常物品、人物关系、自然天气、交通旅行、学习工作、家居房间、身体健康、服饰穿搭、数码网络、文娱运动、城市地点十四类主题，与关键词、词性、掌握状态组合筛选。列表每批加载 30 条。
- 例句突出当前单词及已收录词形，词根／词缀按实际拼写高亮。书页与嫩芽 Logo 应用于桌面图标、启动页和应用内。
- 30 个句子课程：点按彩色词块查看主语、动词、时间、地点、来源等作用；整句／词块朗读；点选排列、提示与替代语序反馈；新增点餐、出行、工作、比较、原因与条件句。句子可跳转复习相关单词。
